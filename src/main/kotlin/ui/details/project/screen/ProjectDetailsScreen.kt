...
fun ProjectDetailsScreen(
    ...
    var distributeSpecialties =
        mutableStateListOf<ProjectSpecialty>(
    ...
    Column(
        ...
        EditableNumberField(title = "Количество мест", editableNumber = places, maxNumberCount = 3) {
            places = it.toIntOrNull() ?: 0
        }
